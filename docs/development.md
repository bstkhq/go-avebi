...
The repository depends directly on the validated v1.1.2 release:

```text
github.com/bstkhq/go-ffmpeg-ffi v1.1.2
```
...
- reusable hardware-device contexts across repeated player opens.
